...
export declare const isConcurrentMerkleTreeHeaderDataV1: (x: ConcurrentMerkleTreeHeaderData) => x is ConcurrentMerkleTreeHeaderData & {
    __kind: "V1";
};
/**
 * @category userTypes
 * @category generated
 */
export declare const concurrentMerkleTreeHeaderDataBeet: beet.FixableBeet<ConcurrentMerkleTreeHeaderData, ConcurrentMerkleTreeHeaderData>;
