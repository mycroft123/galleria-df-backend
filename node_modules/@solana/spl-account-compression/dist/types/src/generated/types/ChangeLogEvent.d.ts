...
import { ChangeLogEventV1 } from './ChangeLogEventV1';
/**
...
export declare const isChangeLogEventV1: (x: ChangeLogEvent) => x is ChangeLogEvent & {
    __kind: "V1";
};
/**
 * @category userTypes
 * @category generated
 */
export declare const changeLogEventBeet: beet.FixableBeet<ChangeLogEvent, ChangeLogEvent>;
//# sourceMappingURL=ChangeLogEvent.d.ts.map