...
import { ApplicationDataEventV1 } from './ApplicationDataEventV1';
/**
...
export declare const isApplicationDataEventV1: (x: ApplicationDataEvent) => x is ApplicationDataEvent & {
    __kind: "V1";
};
/**
 * @category userTypes
 * @category generated
 */
export declare const applicationDataEventBeet: beet.FixableBeet<ApplicationDataEvent, ApplicationDataEvent>;
//# sourceMappingURL=ApplicationDataEvent.d.ts.map